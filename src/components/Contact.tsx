...
function ContactCard({ method, index }: ContactCardProps) {
  return (
    <motion.a
      ...
      className="block"
    >
      <GlassCard className="group h-full p-6" hoverEffect index={index}>
        {/* Icon section */}
        <div className="mb-6">
          <AnimatedIcon
            variant="scale"
...
export default function Contact() {
  return (
    <SectionWrapper id="contact" backgroundVariant="scattered" gradientDirection="diagonal">
      <SectionHeader
        badge="Get In Touch"
        title="Contact Me"
        description="Ready to start your next project? Let&apos;s discuss how my DevOps expertise can help streamline your infrastructure and accelerate your development workflow"
      />
      ...
      <StatsContainer>
        <StatCard 
          ...
          label="For Projects" 
          color="green"
          icon={<div className="w-2 h-2 bg-green-400 rounded-full animate-ping"></div>}
        />
