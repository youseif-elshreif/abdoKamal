...
export default function ProjectCard({
  ...
  return (
    ...
    >
      ...
      <div 
        className="relative backdrop-blur-xl border border-blue-400/20 overflow-hidden transition-all duration-700 transform-gpu hover:border-blue-400/40"
        style={{
          borderRadius: '20px',
        ...
        <div className="relative h-48 overflow-hidden">
          ...
          >
            ...
            <motion.button
              ...
              className="absolute top-3 right-3 w-8 h-8 rounded-lg border border-blue-400/30 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-300"
              style={{
